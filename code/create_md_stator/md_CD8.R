...
#Metadata created for CD8 T cells from baseline 
...
annotations_haradhvala_sub <- read_delim(paste0(wd, "data/metadata/Fig3_ALLT_knnsubtypes_annotated_obs.txt"), 
                                         delim = "\t", escape_double = FALSE, trim_ws = TRUE)

subset_CD8_raw_18755 <- read.csv(paste0(wd,"data/stator_results/CD8_baseline/Shiny/subset_CD8_raw_18755.csv"))
trainData <- read.csv(paste0(wd,"data/stator_results/CD8_baseline/Shiny/trainingData_18755Cells_1000Genes.csv"))

md_CD8 <- read.csv(paste0(wd,"data/stator_results/CD8_baseline/Shiny/CD8_md_joint.csv"))

subset_CD8_sc <- read.csv(paste0(wd,"data/stator_results/CD8_baseline/Shiny/md_scanpy.csv"))
subset_CD8_md <- read.csv(paste0(wd, "data/output_baseline/stator_input/CD8/subset_CD8_md.csv"))
...
write.csv(md_subtype, paste0(wd,"data/stator_results/CD8_baseline/Shiny/CD8_md_subtype.csv"))

md_sex <- subset_CD8_md_sub[, c("X","label", "sex")]
rownames(md_sex) <- md_sex$X
md_sex <- md_sex[,-1]
write.csv(md_sex, paste0(wd,"data/stator_results/CD8_baseline/Shiny/CD8_md_sex.csv"))
...
write.csv(md_sex_joint, paste0(wd,"data/stator_results/CD8_baseline/Shiny/CD8_md_sex_joint.csv"))
...
write.csv(md_label_joint, paste0(wd, "data/stator_results/CD8_baseline/Shiny/CD8_md_joint.csv"))
write.csv(subset_CD8_raw_18755, paste0(wd,"data/stator_results/CD8_baseline/Shiny/subset_CD8_raw_18755.csv"), quote=FALSE)
