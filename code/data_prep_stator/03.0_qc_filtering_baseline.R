...
seurat_object <- readRDS(paste0(wd, "data/output_baseline/baseline_raw_md_annot.rds"))
...
#Quality filtered seurat objects
output_path <- paste0(wd, "data/output_baseline/")
