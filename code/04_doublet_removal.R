...
#seurat_obj_no_rbc <- readRDS(paste0(wd, "data/output_baseline/baseline_filtered_no_rbc_md_annot.rds"))
...
#if (file.exists(paste0(wd, "data/output_baseline/"))) {cat("The folder already exists")} else {dir.create(paste0(wd, "data/output_baseline/"))}
